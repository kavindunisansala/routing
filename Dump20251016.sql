...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-09-23 15:48:30',NULL),('diagnostics.include_raw','OFF','2025-09-23 15:48:30',NULL),('ps_thread_trx_info.max_length','65535','2025-09-23 15:48:30',NULL),('statement_performance_analyzer.limit','100','2025-09-23 15:48:30',NULL),('statement_performance_analyzer.view',NULL,'2025-09-23 15:48:30',NULL),('statement_truncate_len','64','2025-09-23 15:48:30',NULL);
...
-- Dump completed on 2025-10-16 13:48:28
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: localhost    Database: krishna1
-- ------------------------------------------------------
-- Server version	8.0.43
...
CREATE TABLE `attendence` (
  ...
  `employeename` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `employee_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `intimedate` date DEFAULT NULL,
  `intime` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `outdate` date DEFAULT NULL,
  `outtime` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `attendence` VALUES (454,'admin','1','2025-09-19','02:09:58','2025-09-19','04:30:42',NULL),(455,'admin','1','2025-09-20','00:02:48','2025-09-20','01:05:02',NULL),(456,'testuser','00000002','2025-09-20','00:20:45','2025-09-20','01:14:59',NULL),(457,'Ayeshman','999','2025-09-23','19:28:57','2025-09-23','19:34:04',NULL),(458,'Ayeshman ','9999','2025-09-23','19:35:43','2025-09-23','23:28:14',NULL),(459,'Imesh KBK','9998','2025-09-23','19:40:29','2025-09-23','20:02:13',NULL),(460,'Ayeshman ','9999','2025-09-24','00:17:34','2025-09-24','00:17:34',NULL),(461,'Ranil','5','2025-09-25','07:16:46','2025-09-25','17:10:16',NULL),(462,'Ayeshman ','9999','2025-09-26','00:10:23','2025-09-26','00:10:56',NULL),(463,'Ranil','5','2025-09-26','00:11:06','2025-09-26','00:11:16',NULL),(464,'Ranil','5','2025-09-30','12:15:19','2025-09-30','16:47:19',NULL),(465,'Ayeshman ','9999','2025-09-30','17:17:11','2025-09-30','17:17:11',NULL),(466,'wimukthi','1','2025-10-02','19:19:14','2025-10-02','19:19:44',NULL),(467,'Viraj','9','2025-10-02','19:58:12','2025-10-02','19:58:19',NULL),(468,'Ranil','500','2025-10-04','19:23:37','2025-10-04','19:23:37',NULL),(469,'Angelo','75','2025-10-14','13:42:51','2025-10-14','13:42:51',NULL),(470,'Sujith','76','2025-10-14','13:45:19','2025-10-14','13:45:19',NULL),(471,'kalana','499','2025-10-14','14:02:10','2025-10-14','14:05:16',NULL);
...
CREATE TABLE `auth` (
  ...
  `dash` tinyint(1) DEFAULT '0',
  `cusreg` tinyint(1) DEFAULT '0',
  `salery` tinyint DEFAULT '0',
  `payslip` tinyint(1) DEFAULT '0',
  `attende` tinyint(1) DEFAULT '0',
  `employee_reg` tinyint(1) DEFAULT '0',
  `can_delete` tinyint(1) DEFAULT '0',
  `can_update` tinyint(1) DEFAULT '0',
  `edit` tinyint(1) DEFAULT '0',
  `rollname` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `auth` VALUES ('admin',12345,'Admin','Admin',1,1,1,1,1,1,1,1,1,'Admin'),('aka',12345,'sasasa','ssasa',0,1,0,0,1,1,0,1,1,'Admin');
...
CREATE TABLE `customer` (
  `inid` int NOT NULL,
  `cusName` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tel` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `max_lim` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `curr_lim` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `nic` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `overrate` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `membership_planid` int NOT NULL,
  `startdate` date DEFAULT NULL,
  `enddate` date DEFAULT NULL,
  PRIMARY KEY (`inid`),
  KEY `membership_id_idx` (`membership_planid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `customer_fitness_assessment`
--

DROP TABLE IF EXISTS `customer_fitness_assessment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `customer_fitness_assessment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_id` int DEFAULT NULL,
  `chest` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chest_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'cm',
  `waist` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arms` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thighs` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `blood_pressure` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `heart_rate` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body_fat` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `muscle_mass` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assessment_date` date DEFAULT NULL,
  `assessed_by` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `customer_fitness_assessment`
--

LOCK TABLES `customer_fitness_assessment` WRITE;
/*!40000 ALTER TABLE `customer_fitness_assessment` DISABLE KEYS */;
INSERT INTO `customer_fitness_assessment` VALUES (190,39,'','In','','','','','','','',NULL,''),(192,41,'','In','','','','','','','',NULL,''),(193,42,'','In','','','','','','','',NULL,''),(194,43,'','In','','','','','','','',NULL,''),(195,44,'','In','','','','','','','',NULL,''),(196,45,'','In','','','','','','','',NULL,''),(197,46,'','In','','','','','','','',NULL,''),(198,47,'','In','','','','','','','',NULL,''),(199,48,'','In','','','','','','','',NULL,''),(200,49,'','In','','','','','','','',NULL,''),(201,50,'','In','','','','','','','',NULL,''),(202,51,'','In','','','','','','','',NULL,''),(203,52,'','In','','','','','','','',NULL,''),(204,53,'','In','','','','','','','',NULL,''),(206,55,'','In','','','','','','','',NULL,''),(207,56,'','In','','','','','','','',NULL,''),(208,57,'','In','','','','','','','',NULL,''),(209,58,'','In','','','','','','','',NULL,''),(210,59,'','In','','','','','','','',NULL,''),(211,60,'','In','','','','','','','',NULL,''),(212,61,'','In','','','','','','','',NULL,''),(213,62,'','In','','','','','','','',NULL,''),(214,63,'','In','','','','','','','',NULL,''),(215,64,'','In','','','','','','','',NULL,''),(216,65,'','In','','','','','','','',NULL,''),(217,66,'','In','','','','','','','',NULL,''),(218,67,'','In','','','','','','','',NULL,''),(219,68,'','In','','','','','','','',NULL,''),(220,69,'','In','','','','','','','',NULL,''),(221,70,'','In','','','','','','','',NULL,''),(222,71,'','In','','','','','','','',NULL,''),(223,72,'','In','','','','','','','',NULL,''),(224,73,'','In','','','','','','','',NULL,''),(225,74,'','In','','','','','','','',NULL,''),(226,75,'','In','','','','','','','',NULL,''),(227,76,'','In','','','','','','','',NULL,''),(228,77,'','In','','','','','','','',NULL,''),(229,78,'','In','','','','','','','',NULL,''),(232,81,'','In','','','','','','','',NULL,''),(233,82,'','In','','','','','','','',NULL,''),(234,83,'','In','','','','','','','',NULL,''),(235,84,'','In','','','','','','','',NULL,''),(236,85,'','In','','','','','','','',NULL,''),(237,86,'','In','','','','','','','',NULL,''),(238,87,'','In','','','','','','','',NULL,''),(239,88,'','In','','','','','','','',NULL,''),(240,89,'','In','','','','','','','',NULL,''),(243,90,'','In','','','','','','','',NULL,''),(244,91,'','In','','','','','','','',NULL,''),(245,92,'','In','','','','','','','',NULL,''),(246,93,'','In','','','','','','','',NULL,''),(249,94,'','In','','','','','','','',NULL,''),(250,95,'','In','','','','','','','',NULL,''),(251,96,'','In','','','','','','','',NULL,''),(252,97,'','In','','','','','','','',NULL,''),(253,98,'','In','','','','','','','',NULL,''),(254,99,'','In','','','','','','','',NULL,''),(255,100,'','In','','','','','','','',NULL,''),(256,101,'','In','','','','','','','',NULL,''),(257,102,'','In','','','','','','','',NULL,''),(258,103,'','In','','','','','','','',NULL,''),(259,104,'','In','','','','','','','',NULL,''),(260,105,'','In','','','','','','','',NULL,''),(261,106,'','In','','','','','','','',NULL,''),(262,107,'','In','','','','','','','',NULL,''),(263,108,'','In','','','','','','','',NULL,''),(264,109,'','In','','','','','','','',NULL,''),(265,110,'','In','','','','','','','',NULL,''),(266,111,'','In','','','','','','','',NULL,''),(267,112,'','In','','','','','','','',NULL,''),(268,113,'','In','','','','','','','',NULL,''),(273,54,'','In','','','','','','','',NULL,''),(275,40,'','In','','','','','','','',NULL,''),(277,115,'','In','','','','','','','',NULL,''),(278,116,'','In','','','','','','','',NULL,''),(285,7,'','In','','','','','','','',NULL,''),(286,8,'','In','','','','','','','',NULL,''),(290,12,'','In','','','','','','','',NULL,''),(291,13,'','In','','','','','','','',NULL,''),(292,14,'','In','','','','','','','',NULL,''),(293,15,'','In','','','','','','','',NULL,''),(294,16,'','In','','','','','','','',NULL,''),(295,17,'','In','','','','','','','',NULL,''),(297,19,'','In','','','','','','','',NULL,''),(298,18,'','In','','','','','','','',NULL,''),(299,20,'','In','','','','','','','',NULL,''),(300,21,'','In','','','','','','','',NULL,''),(301,22,'','In','','','','','','','',NULL,''),(302,23,'','In','','','','','','','',NULL,''),(305,26,'','In','','','','','','','',NULL,''),(306,27,'','In','','','','','','','',NULL,''),(307,28,'','In','','','','','','','',NULL,''),(308,29,'','In','','','','','','','',NULL,''),(309,30,'','In','','','','','','','',NULL,''),(310,31,'','In','','','','','','','',NULL,''),(311,32,'','In','','','','','','','',NULL,''),(312,33,'','In','','','','','','','',NULL,''),(313,34,'','In','','','','','','','',NULL,''),(314,35,'','In','','','','','','','',NULL,''),(315,36,'','In','','','','','','','',NULL,''),(316,37,'','In','','','','','','','',NULL,''),(317,38,'','In','','','','','','','',NULL,''),(321,117,'','In','','','','','','','',NULL,''),(322,1,'','In','','','','','','','',NULL,''),(323,2,'','In','','','','','','','',NULL,''),(324,3,'','In','','','','','','','',NULL,''),(325,4,'','In','','','','','','','',NULL,''),(326,6,'','In','','','','','','','',NULL,''),(327,10,'','In','','','','','','','',NULL,''),(328,9,'','In','','','','','','','',NULL,''),(329,5,'','In','','','','','','','',NULL,''),(330,11,'','In','','','','','','','',NULL,''),(331,24,'','In','','','','','','','',NULL,'');
/*!40000 ALTER TABLE `customer_fitness_assessment` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `customer_memberships` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_id` int DEFAULT NULL,
  `membership_planid` int DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `member_idx` (`customer_id`),
  KEY `membership_idx` (`membership_planid`),
  CONSTRAINT `member` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `membership` FOREIGN KEY (`membership_planid`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `customer_memberships` VALUES (322,3,45,'2025-10-16','2025-10-19','2025-10-16','active','2025-09-30 17:35:38'),(324,5,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 01:21:56'),(325,6,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 01:34:56'),(326,7,45,'2025-10-01','2025-11-04','2025-10-01','active','2025-10-01 01:38:48'),(327,8,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 01:48:48'),(328,9,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 01:59:03'),(329,10,48,'2025-09-30','2025-10-03','2025-09-30','active','2025-10-01 02:06:07'),(330,11,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 02:14:40'),(331,12,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 02:21:09'),(332,13,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 02:52:00'),(333,14,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 03:17:31'),(334,15,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 03:24:53'),(335,16,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 03:32:55'),(336,17,45,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 03:45:03'),(337,18,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 04:12:50'),(338,19,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 04:16:09'),(339,20,45,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 04:23:21'),(340,21,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 05:58:14'),(341,22,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 06:02:04'),(342,23,48,'2025-10-01','2025-11-04','2025-10-01','active','2025-10-01 06:11:51'),(343,24,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 06:16:07'),(344,26,45,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 06:23:42'),(345,27,48,'2025-10-01','2025-10-04','2025-10-01','expired','2025-10-01 06:38:09'),(346,28,48,'2025-10-01','2025-11-01','2025-10-01','active','2025-10-01 06:42:18'),(347,29,45,'2025-10-01','2025-11-04','2025-10-01','active','2025-10-01 06:56:33'),(349,30,51,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 00:40:06'),(350,31,51,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 00:48:50'),(351,32,45,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 00:57:30'),(352,33,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:05:46'),(353,34,48,'2025-10-02','2025-11-05','2025-10-02','active','2025-10-02 01:09:43'),(354,35,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:15:16'),(355,36,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:22:54'),(356,37,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:28:22'),(357,38,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:33:13'),(358,39,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:41:42'),(359,40,51,'2025-09-30','2025-11-03','2025-09-30','active','2025-10-02 01:45:31'),(360,41,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 01:52:28'),(361,42,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:06:15'),(362,43,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:10:15'),(363,44,45,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:15:02'),(364,45,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:18:13'),(365,46,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:23:57'),(366,47,45,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:26:20'),(367,48,45,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 02:28:49'),(368,49,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 04:59:46'),(369,50,48,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 05:13:18'),(370,51,45,'2025-10-02','2025-11-05','2025-10-02','active','2025-10-02 05:17:35'),(371,52,51,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 05:41:05'),(372,53,48,'2025-10-02','2025-11-05','2025-10-02','active','2025-10-02 05:45:44'),(373,54,54,'2025-10-02','2026-01-02','2025-10-02','active','2025-10-02 08:44:54'),(374,55,54,'2025-10-02','2025-10-05','2025-10-02','expired','2025-10-02 08:47:53'),(375,56,48,'2025-10-03','2025-10-06','2025-10-03','expired','2025-10-03 01:23:14'),(376,57,48,'2025-10-03','2025-10-06','2025-10-03','expired','2025-10-03 01:26:13'),(377,58,48,'2025-10-03','2025-10-06','2025-10-03','expired','2025-10-03 01:28:36'),(378,59,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 00:47:11'),(379,60,51,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 00:48:59'),(380,61,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 00:50:52'),(381,62,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 00:53:42'),(382,63,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 00:55:53'),(383,64,48,'2025-10-04','2025-11-07','2025-10-04','active','2025-10-04 01:56:01'),(384,65,45,'2025-10-04','2025-11-07','2025-10-04','active','2025-10-04 04:15:54'),(385,66,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 08:35:35'),(386,67,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 13:04:35'),(387,68,48,'2025-10-04','2025-10-07','2025-10-04','expired','2025-10-04 13:10:36'),(388,69,48,'2025-10-06','2025-10-09','2025-10-06','expired','2025-10-06 03:54:54'),(389,70,48,'2025-10-06','2025-10-09','2025-10-06','expired','2025-10-06 04:20:46'),(390,71,51,'2025-10-06','2025-10-09','2025-10-06','expired','2025-10-06 04:22:48'),(391,72,48,'2025-10-07','2025-11-10','2025-10-07','active','2025-10-07 03:38:39'),(392,73,48,'2025-10-07','2025-10-10','2025-10-07','expired','2025-10-07 03:45:24'),(393,74,48,'2025-10-07','2025-10-10','2025-10-07','expired','2025-10-07 12:34:11'),(394,75,45,'2025-10-07','2025-10-10','2025-10-07','expired','2025-10-07 12:59:47'),(395,76,45,'2025-10-07','2025-10-10','2025-10-07','expired','2025-10-07 13:05:14'),(396,77,45,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 01:56:21'),(397,78,45,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:00:03'),(400,81,45,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:10:12'),(401,82,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:11:59'),(402,83,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:13:55'),(403,84,51,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:15:54'),(404,85,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:17:40'),(405,86,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:19:30'),(406,87,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 02:21:23'),(407,88,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 08:16:23'),(408,89,48,'2025-10-08','2025-10-11','2025-10-08','expired','2025-10-08 08:18:27'),(409,90,48,'2025-10-09','2025-10-12','2025-10-09','expired','2025-10-09 01:14:49'),(410,91,51,'2025-10-09','2025-10-12','2025-10-09','expired','2025-10-09 01:17:55'),(411,92,48,'2025-10-09','2025-10-12','2025-10-09','expired','2025-10-09 01:19:46'),(412,93,48,'2025-10-09','2025-11-12','2025-10-09','active','2025-10-09 04:26:37'),(413,94,48,'2025-10-10','2025-10-13','2025-10-10','expired','2025-10-10 02:11:19'),(414,95,45,'2025-10-10','2025-11-13','2025-10-10','active','2025-10-10 02:13:45'),(415,96,55,'2025-10-10','2025-10-13','2025-10-10','expired','2025-10-10 02:23:21'),(416,97,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:00:29'),(417,98,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:03:01'),(418,99,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:07:23'),(419,100,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:09:26'),(420,101,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:11:20'),(421,102,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 01:24:58'),(422,103,45,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 06:37:08'),(423,104,45,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 06:40:25'),(424,105,48,'2025-10-11','2025-11-14','2025-10-11','active','2025-10-11 11:17:10'),(425,106,48,'2025-10-13','2025-11-16','2025-10-13','active','2025-10-13 12:06:45'),(426,107,45,'2025-10-13','2025-11-16','2025-10-13','active','2025-10-13 12:09:12'),(427,108,48,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-14 01:19:08'),(428,109,45,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-14 01:23:40'),(429,110,48,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-14 01:25:39'),(430,111,48,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-14 01:27:30'),(431,112,48,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-14 04:35:56'),(432,113,48,'2025-10-01','2025-10-01','2025-10-01','expired','2025-10-14 09:11:16'),(435,115,48,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-15 00:01:37'),(436,116,45,'2025-10-14','2025-11-17','2025-10-14','active','2025-10-15 00:03:42'),(437,117,48,'2025-10-15','2025-11-18','2025-10-15','active','2025-10-15 14:17:48'),(438,1,48,'2025-09-25','2025-09-28','2025-09-25','active','2025-10-16 05:23:20'),(439,2,45,'2025-10-16','2025-10-19','2025-10-16','active','2025-10-16 05:24:52'),(440,4,48,'2025-10-16','2025-10-19','2025-10-16','active','2025-10-16 06:47:50');
...
CREATE TABLE `customer_payments` (
  ...
  `payment_date` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('yes','ignore') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'yes',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id_mem` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cus_idx` (`customer_id`),
  KEY `fk_mem_idx` (`id_mem`),
  CONSTRAINT `fk_cus` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_mem` FOREIGN KEY (`id_mem`) REFERENCES `customer_memberships` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
--
-- Table structure for table `customer_relation_contacts`
--

DROP TABLE IF EXISTS `customer_relation_contacts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `customer_relation_contacts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_id` int DEFAULT NULL,
  `relation_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `relation_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '.....',
  `relation_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_customer_idx` (`customer_id`),
  CONSTRAINT `fk_cust` FOREIGN KEY (`id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `customer_relation_contacts`
--

LOCK TABLES `customer_relation_contacts` WRITE;
/*!40000 ALTER TABLE `customer_relation_contacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_relation_contacts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `customers` (
  ...
  `hotline` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `relative_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `relative_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `relative_relation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '.....',
  `photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `height_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'cm',
  ...
  `goal` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Weight Loss',
  `activity_level` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Sedentary',
  `workout_experience` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Beginner',
  `injuries` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `membership_planid_idx` (`membership_planid`),
  CONSTRAINT `membership_planid` FOREIGN KEY (`membership_planid`) REFERENCES `membership_plan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customers` VALUES (1,'Malinga','Fernando','0702888950','','','Male','1993-12-25','Inactive','933602150','2025-09-30 17:01:20','','','2025-09-25','1','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,1),(2,'Keshani ','perera','0757788793','','','Female','2002-04-16','Inactive','200260703680','2025-09-30 17:30:48','','','2025-09-25','2','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,2),(3,'Ranjith','piyasoma','0714932092','','','Male','1996-02-28','Inactive','660590781v','2025-09-30 17:35:38','','','2025-09-25','3','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,3),(4,'Prabath ','bhagya','0722349540','','','Male','2004-03-06','Inactive','200406612179','2025-09-30 17:40:57','','','2025-09-25','4','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,4),(5,'Mohomad','shaharan','0774894820','','','Male','2005-05-31','Inactive','200515201280','2025-10-01 01:21:56','','','2025-09-25','5','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,5),(6,'Pushparaj','sanjeew','0743583924','','','Male','2001-10-24','Inactive','200129803226','2025-10-01 01:34:56','','','2025-09-25','6','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,6),(7,'Waruni','herath','0702011866','','','Female','1996-03-27','Inactive','965653350v','2025-10-01 01:38:48','','','2025-09-25','7','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','\n\n\n\n\n\n\n\n','',NULL,NULL,7),(8,'Buddhika','herath','0755721821','','','Male','1992-03-21','Inactive','92081239v','2025-10-01 01:48:48','','','2025-09-25','8','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,8),(9,'Viraj','ranasinghe','0718861696','','','Male','1992-05-05','Inactive','921260113v','2025-10-01 01:59:03','','','2025-09-25','9','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,9),(10,'Kaviranga ','pinthu','0778423536','','','Male','2005-01-20','Inactive','200502003919','2025-10-01 02:06:07','','','2025-09-30','10','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,10),(11,'Ilmas','sadiqua','0777106035','','','Male','2003-03-26','Inactive','200308601014','2025-10-01 02:14:40','','','2025-09-25','11','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,11),(12,'Dilan','sandaruwan','0767876421','','','Male','1996-11-30','Inactive','963353200v','2025-10-01 02:21:09','','','2025-09-25','12','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,12),(13,'R.M.S','sandaruwan','0777921281','','','Male','1998-05-25','Inactive','981461290v','2025-10-01 02:52:00','','','2025-09-25','13','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,13),(14,'Kalindu','Abeysinghe','0776117514','','','Male','2001-12-30','Inactive','200136510037','2025-10-01 03:17:31','','','2025-09-25','14','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,14),(15,'Kavisha','maduwantha','0706553749','','','Male','1998-08-05','Inactive','982182336','2025-10-01 03:24:53','','','2025-09-25','15','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,15),(16,'Tharusha','Ganepola','0743019666','','','Male','2001-12-07','Inactive','200134203739','2025-10-01 03:32:55','','','2025-09-25','16','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,16),(17,'Amandi','jayarathne','0764730410','','','Female','2001-11-11','Inactive','200181600906','2025-10-01 03:45:03','','','2025-09-25','17','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,17),(18,'W.A.praveen','shashendra','0786199791','','','Male','2008-09-06','Inactive','200825004279','2025-10-01 04:12:50','','','2025-09-25','18','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,18),(19,'W.A.Hashitha','dasun','0781083185','','','Male','2005-01-08','Inactive','200400800045','2025-10-01 04:16:09','','','2025-09-25','19','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,19),(20,'Shanika','dilrukshi','0763631944','','','Female','1995-02-22','Inactive','945532106v','2025-10-01 04:23:21','','','2025-09-26','20','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,20),(21,'Miraj','malinga','0777226848','','','Male','1992-12-19','Inactive','923542876v','2025-10-01 05:58:14','','','2025-09-26','21','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,21),(22,'Ishanka','maduranga','0742773922','','','Male','1995-12-17','Inactive','950173718v','2025-10-01 06:02:04','','','2025-09-26','22','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,22),(23,'Asanka','Rukshan','0703180937','','','Male','2000-06-20','Inactive','','2025-10-01 06:11:51','','','2025-09-27','23','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,23),(24,'Krishan','kasthuriarachchi','0773304548','','','Male','1999-07-27','Inactive','992093722','2025-10-01 06:16:07','','','2025-09-27','24','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,24),(26,'Ishanka','Dilrukshi','0762581397','','','Female','1989-12-28','Inactive','898631311v','2025-10-01 06:23:42','','','2025-09-28','26','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,26),(27,'Pasidu','Hettiarachchi','0715139740','','','Male',NULL,'Inactive','960253728v','2025-10-01 06:38:09','','','2025-10-28','27','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,27),(28,'Dilshan','pushpakumara','0757111383','','','Male','1995-12-25','Inactive','953603519v','2025-10-01 06:42:18','','','2025-09-29','28','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,28),(29,'Rashmi','Saumya','0776515688','','','Female','1996-09-16','Inactive','199676001500','2025-10-01 06:56:33','','','2025-09-29','29','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,29),(30,'Buwaneka','Pabasara','0766748694','','','Male','2001-09-25','Inactive','200126901403','2025-10-02 00:40:06','','','2025-09-29','30','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,30),(31,'shenal','panchali','0759158703','','','Male','1999-11-04','Inactive','998096251v','2025-10-02 00:48:50','','','2025-09-29','32','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,32),(32,'Kithmini','Handaragamage','0719766759','','','Female','2000-02-16','Inactive','200054702852','2025-10-02 00:57:30','','','2025-09-29','32','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,32),(33,'Dinuja','Manchanayaka','0705954541','','','Male','2006-08-27','Inactive','200624003000','2025-10-02 01:05:46','','','2025-09-29','35','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,35),(34,'Ravindu','Nimantha','0713467666','','','Male','2006-08-27','Inactive','','2025-10-02 01:09:43','','','2025-09-29','36','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,36),(35,'Vihaga','Anush','0759808733','','','Male','2006-06-12','Inactive','200616404470','2025-10-02 01:15:16','','','2025-09-29','37','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,37),(36,'Rasika','Duminda','0718438175','','','Male','1983-06-05','Inactive','','2025-10-02 01:22:54','','','2025-09-29','38','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,38),(37,'Isuru','Hemantha','0774262259','','','Male','1994-08-25','Inactive','941441929v','2025-10-02 01:28:22','','','2025-09-29','39','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,39),(38,'Dineth','Madushanka','0784337602','','','Male','1999-02-03','Inactive','980340546v','2025-10-02 01:33:13','','','2025-09-29','40','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,40),(39,'Subash','priyankara','0777757479','','','Male','1991-11-12','Inactive','913170016v','2025-10-02 01:41:42','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,43),(40,'Sahan','Nimnadi','0768285626','','','Male','2025-10-26','Inactive','','2025-10-02 01:45:31','','','2025-09-30','42','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,42),(41,'Chiran','wenuja','0701489303','','','Male','2007-01-26','Inactive','2007026040','2025-10-02 01:52:28','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,45),(42,'Dinusha','gunawardana','0775820958','','','Male','1992-11-07','Inactive','923124403v','2025-10-02 02:06:15','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,44),(43,'Mahesh','lakshana','0716941424','','','Male','1993-10-31','Inactive','933053310v','2025-10-02 02:10:15','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,46),(44,'Koshila','punyanadi','0776538083','','','Female','1997-09-15','Inactive','199775903042','2025-10-02 02:15:02','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,47),(45,'Saneera','Rajapaksha','0773852318','','','Male','2002-02-18','Inactive','200204903874','2025-10-02 02:18:13','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,48),(46,'Dunura','Dilshan','0712707352','','','Male','1999-06-08','Inactive','199916010658','2025-10-02 02:23:57','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,49),(47,'Sanduni','Thilakshi','0721582040','','','Female','2002-10-24','Inactive','200279308060','2025-10-02 02:26:20','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,50),(48,'Sandunika','Hansani','07026487503','','','Female','1994-10-17','Inactive','947814481','2025-10-02 02:28:49','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,51),(49,'Eshan','jayasooriya','071988290','','','Male','2006-04-12','Inactive','2005103038880','2025-10-02 04:59:46','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,52),(50,'Ransilu','Jayasinghe','0776780938','','','Male','1990-10-18','Inactive','902920919v','2025-10-02 05:13:18','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,25),(51,'Sandani','Gunawardana','0777060508','','','Female','1983-05-13','Inactive','836341619v','2025-10-02 05:17:35','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,57),(52,'Chanul','Nihinsa','0777238384','','','Male','2004-11-22','Inactive','200432705173','2025-10-02 05:41:05','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,58),(53,'Rohan','Wijeweera','0773315674','','','Male','1971-07-26','Inactive','712081830','2025-10-02 05:45:44','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,60),(54,'Navodya','Ravinda','0773456331','','','Male',NULL,'Inactive','992536101','2025-10-02 08:44:54','','','2025-10-01','53','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,53),(55,'AShinsa','Nimesh','0754651778','','','Male',NULL,'Inactive','200728903188','2025-10-02 08:47:53','','','2025-10-02','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,55),(56,'Alnotha','Namal','0760100428','','','Male','1984-12-03','Inactive','8433833130v','2025-10-03 01:23:14','','','2025-10-03','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,61),(57,'Achintha','Madusanka','0761995239','','','Male','1988-03-06','Inactive','8706614360','2025-10-03 01:26:13','','','2025-10-03','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,62),(58,'Thilina','Ganepola','0717047081','','','Male','1990-11-16','Inactive','903210095v','2025-10-03 01:28:36','','','2025-10-03','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,63),(59,'Chandrasekara','D,S','0701108740','','','Male','1987-06-12','Inactive','861640574V','2025-10-04 00:47:11','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,64),(60,'Ashan','Xena','0715667871','','','Male',NULL,'Inactive','199301304295','2025-10-04 00:48:59','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,66),(61,'Kumara','senu','0772997073','','','Male','1978-03-15','Inactive','197807501762v','2025-10-04 00:50:52','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,67),(62,'Shenal','Chanuka','0701028509','','','Male','2003-04-04','Inactive','200309513558','2025-10-04 00:53:42','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,68),(63,'Krishan','Fernando','0768734743','','','Male','2000-08-24','Inactive','200023703284','2025-10-04 00:55:53','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,69),(64,'Janith','Hathnagoda','0714591034','','','Male','2000-03-03','Inactive','20006302061','2025-10-04 01:56:01','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,70),(65,'Gayani','Wijesinghe','0760836840','','','Male','1980-08-27','Inactive','808800779v','2025-10-04 04:15:54','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,71),(66,'Kveeja','Wijerathna','0717686686','','','Male','2008-12-10','Inactive','','2025-10-04 08:35:35','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,72),(67,'Sathira','weerasinghe','0741735858','','','Male','2009-01-28','Inactive','','2025-10-04 13:04:35','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,73),(68,'Nimesh','Madagedara','0779346754','','','Male','1996-05-11','Inactive','961323908','2025-10-04 13:10:36','','','2025-10-04','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,74),(69,'Shenal','Angelo','0779697489','','','Male','2002-05-09','Inactive','200213000450','2025-10-06 03:54:54','','','2025-10-06','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,75),(70,'Sujith','Jonson','0764667760','','','Male','1999-02-07','Inactive','199900711090','2025-10-06 04:20:46','','','2025-10-06','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,76),(71,'Chamith','Tharanga','0710584934','','','Male','1993-05-14','Inactive','931350293v','2025-10-06 04:22:48','','','2025-10-06','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,78),(72,'Sudesh','kalpitha','0713372337','','','Male','1983-01-18','Inactive','19830181644','2025-10-07 03:38:39','','','2025-10-07','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,80),(73,'Charith','Wijerathna','0775532053','','','Male','1993-01-30','Inactive','930303380v','2025-10-07 03:45:24','','','2025-10-07','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,79),(74,'Dulip','Anuruddha','0713075478','','','Male','1990-10-31','Inactive','905030721','2025-10-07 12:34:11','','','2025-10-07','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,81),(75,'Shihara ','Rajapaksha ','0718226145','','','Female','1995-09-13','Inactive','957571158v','2025-10-07 12:59:47','','','2025-10-07','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,82),(76,'Diana','Pushpamali','0714466675','','','Female','1977-04-27','Inactive','197761802613','2025-10-07 13:05:14','','','2025-10-07','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,83),(77,'Buddima','Kalpani','0718574024','','','Female','1999-04-09','Inactive','996002047v','2025-10-08 01:56:21','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,85),(78,'Buddhini','Anjana','0702320220','','','Female','1999-06-13','Inactive','996655636v','2025-10-08 02:00:03','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,84),(81,'Harshika','weerawardane','0711757929','','','Female','1997-03-11','Inactive','975711420','2025-10-08 02:10:12','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,86),(82,'Savindu','Chamalka','0765440664','','','Male','1997-01-10','Inactive','970101780v','2025-10-08 02:11:59','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,87),(83,'Mihidina','Jananjana','0781130894','','','Male','2000-05-31','Inactive','200015202383','2025-10-08 02:13:55','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,88),(84,'Lehansa','Ganidu','0710763182','','','Male','2003-07-10','Inactive','200319212320','2025-10-08 02:15:54','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,90),(85,'Yeshan','Pamodya','0762514148','','','Male','2000-05-20','Inactive','20001410255','2025-10-08 02:17:40','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,91),(86,'Maleesha','Ravisara','0705115885','','','Male','2001-12-03','Inactive','200133802455','2025-10-08 02:19:30','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,92),(87,'Dasun','Thathsara','0772329314','','','Male','1996-05-09','Inactive','9613006220','2025-10-08 02:21:23','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,93),(88,'Thimira','Dhananjaya','07754043721','','','Male','1991-11-07','Inactive','913122909v','2025-10-08 08:16:23','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,95),(89,'Punsara','Hasaranga','0713713074','','','Male','2000-04-17','Inactive','200010800992','2025-10-08 08:18:27','','','2025-10-08','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,94),(90,'Thilan','Athukorala','0763594414','','','Male','2008-02-15','Inactive','','2025-10-09 01:14:49','','','2025-10-09','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,96),(91,'Prasanga','Sheni','0777698710','','','Male','1987-06-17','Inactive','871691991v','2025-10-09 01:17:55','','','2025-10-09','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,98),(92,'Thevindu','Wijesinghe','0779814911','','','Male','2001-01-18','Inactive','200101800878','2025-10-09 01:19:46','','','2025-10-09','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,99),(93,'Chanupa','Athssara','0766992183','','','Male','2002-10-20','Inactive','200229403370','2025-10-09 04:26:37','','','2025-10-09','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,100),(94,'Gayantha','Nipunsara','0783863333','','','Male','2000-07-11','Inactive','200019301585','2025-10-10 02:11:19','','','2025-10-10','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,101),(95,'Inoka','Ahangama','0773563119','','','Female','1976-07-22','Inactive','767043104v','2025-10-10 02:13:45','','','2025-10-10','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,103),(96,'Priyan','Suriyaarachchi','0702330109','','','Male','1990-12-21','Inactive','903562218v','2025-10-10 02:23:21','','','2025-10-10','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,102),(97,'Heshan','Dileep','0789725663','','','Male','2000-03-03','Inactive','20006302045','2025-10-11 01:00:29','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,104),(98,'Venuraka','Venuraka','0718179492','','','Male','2008-07-01','Inactive','','2025-10-11 01:03:01','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,105),(99,'Abhishek','Madhusha','0785808496','','','Male','2001-04-29','Inactive','200112002182','2025-10-11 01:07:23','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,106),(100,'Nipuna','Indrajith','0715730895','','','Male','2001-06-05','Inactive','20015702443','2025-10-11 01:09:26','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,107),(101,'Ramitha','Sahas','0742001204','','','Male','2009-01-24','Inactive','','2025-10-11 01:11:20','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,108),(102,'Sasanka','Anupama','0701469211','','','Male','2004-03-19','Inactive','200407913141','2025-10-11 01:24:58','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,109),(103,'Nethmi','Kavindi','0757406474','','','Female','2004-10-05','Inactive','200477901559','2025-10-11 06:37:08','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,110),(104,'Nadini','Dissanayake','0707682880','','','Female','2002-05-03','Inactive','200262401214','2025-10-11 06:40:25','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,111),(105,'Vidupa','Kiriella','0777709449','','','Male','2010-03-20','Inactive','','2025-10-11 11:17:10','','','2025-10-11','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,112),(106,'Dinesh','Karunnarathna','0728063369','','','Male','1988-12-07','Inactive','883423437v','2025-10-13 12:06:45','','','2025-10-13','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,113),(107,'Anne','Sharpne','0704414874','','','Female','2006-02-04','Inactive','200653500160','2025-10-13 12:09:12','','','2025-10-13','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,114),(108,'Chaviru','Sirisena','0718030379','','','Male','1980-10-10','Inactive','802843941v','2025-10-14 01:19:08','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,115),(109,'Oshadhi','Bandara','0763362644','','','Female','2001-06-21','Inactive','200167301329','2025-10-14 01:23:40','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,116),(110,'Ashan','Sanjaya','0756610229','','','Male','1993-01-26','Inactive','930262285v','2025-10-14 01:25:39','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,117),(111,'Nilusha','Mihiran','0752383721','','','Male','2006-09-28','Inactive','200627205635','2025-10-14 01:27:30','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,118),(112,'Kaveen','Narangoda','0767765944','','','Male','2005-03-29','Inactive','200508901556','2025-10-14 04:35:56','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,119),(113,'kalana','gamage','0723202021','','','Male',NULL,'Inactive','','2025-10-14 09:11:16','','','2025-10-01','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,499),(115,'Dilshan','Kularathne','0773400594','','','Male','1998-07-22','Inactive','982040507v','2025-10-15 00:01:37','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,120),(116,'Heshara','Kavindunie','0763826369','','','Female','1999-06-16','Inactive','996683699v','2025-10-15 00:03:42','','','2025-10-14','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,121),(117,'Manjith','Rajarathna','0743673837','','','Male','1997-09-03','Inactive','199724703383','2025-10-15 14:17:48','','','2025-10-15','','','.....',NULL,'cm','','','Weight Loss ','Sedentary','Beginner','','',NULL,NULL,122);
...
CREATE TABLE `membership_duration` (
  ...
  `duration_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cancellation_fee` decimal(10,2) DEFAULT '0.00',
  `durationplan` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Ongoing',
  PRIMARY KEY (`id`),
  KEY `plan_id` (`plan_id`),
  CONSTRAINT `membership_duration_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE
...
LOCK TABLES `membership_duration` WRITE;
/*!40000 ALTER TABLE `membership_duration` DISABLE KEYS */;
INSERT INTO `membership_duration` VALUES (34,45,NULL,NULL,NULL,'Unknown'),(37,48,NULL,NULL,NULL,'Unknown'),(40,51,NULL,NULL,NULL,'Unknown'),(43,54,5,'Year(s)',0.00,'Limited'),(44,55,3,'Month(s)',0.00,'Limited');
/*!40000 ALTER TABLE `membership_duration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `membership_notifications`
--

DROP TABLE IF EXISTS `membership_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `membership_notifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `plan_id` int NOT NULL,
  `send_sms_on_purchase` tinyint(1) DEFAULT '0',
  `notify_before_expiry` tinyint(1) DEFAULT '0',
  `block_after_expiry` tinyint(1) DEFAULT '0',
  `days_before_expiry` int DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `plan_id` (`plan_id`),
  CONSTRAINT `membership_notifications_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `membership_notifications`
--

LOCK TABLES `membership_notifications` WRITE;
/*!40000 ALTER TABLE `membership_notifications` DISABLE KEYS */;
INSERT INTO `membership_notifications` VALUES (36,45,0,0,0,0),(39,48,0,0,0,0),(42,51,0,0,0,0),(45,54,0,0,0,0),(46,55,0,0,0,0);
/*!40000 ALTER TABLE `membership_notifications` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `membership_payments` (
  ...
  `status` enum('PAID','PARTIAL','UNPAID','REFUNDED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'UNPAID',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `signup_fee` decimal(10,2) DEFAULT '0.00',
  `payamount` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
  PRIMARY KEY (`id`),
  UNIQUE KEY `invoice_number` (`invoice_number`),
  KEY `idx_membership_payment_plan` (`membership_plan_id`),
  ...
  CONSTRAINT `fk_membership_payment_plan` FOREIGN KEY (`membership_plan_id`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `membership_payments` VALUES (99,34,48,'INV-20251004-488','2025-10-04 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-05','PAID','2025-10-04 19:30:03',0.00,'6000.0'),(101,51,45,'INV-20251008-319','2025-10-08 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-05','PAID','2025-10-08 07:58:24',0.00,'5000.0'),(102,64,48,'INV-20251008-158','2025-10-08 00:00:00',6000.00,0.00,0.00,6000.00,'ONLINE','2025-11-07','PAID','2025-10-08 08:35:21',0.00,'6000.0'),(103,72,48,'INV-20251008-150','2025-10-08 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-10','PAID','2025-10-08 08:44:51',0.00,'6000.0'),(104,7,45,'INV-20251008-483','2025-10-08 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-04','PAID','2025-10-08 18:25:29',0.00,'5000.0'),(105,53,48,'INV-20251009-628','2025-10-09 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-05','PAID','2025-10-09 07:07:28',0.00,'6000.0'),(106,23,48,'INV-20251009-104','2025-10-09 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-04','PAID','2025-10-09 08:19:33',0.00,'6000.0'),(107,29,45,'INV-20251009-259','2025-10-09 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-04','PAID','2025-10-09 08:21:14',0.00,'5000.0'),(108,93,48,'INV-20251009-197','2025-10-09 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-12','PAID','2025-10-09 09:57:11',0.00,'6000.0'),(109,65,45,'INV-20251009-574','2025-10-09 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-07','PAID','2025-10-09 10:52:48',0.00,'5000.0'),(110,95,45,'INV-20251010-700','2025-10-10 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-13','PAID','2025-10-10 10:06:08',0.00,'5000.0'),(111,10,48,'INV-20251010-113','2025-10-10 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-04','PAID','2025-10-10 11:46:40',0.00,'6000.0'),(112,102,48,'INV-20251011-271','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'ONLINE','2025-11-14','PAID','2025-10-11 06:56:04',0.00,'6000.0'),(113,101,48,'INV-20251011-241','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 06:57:26',0.00,'6000.0'),(114,100,48,'INV-20251011-347','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 06:58:14',0.00,'6000.0'),(115,99,48,'INV-20251011-919','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 07:01:32',0.00,'6000.0'),(116,98,48,'INV-20251011-531','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 07:02:36',0.00,'6000.0'),(117,97,48,'INV-20251011-887','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 07:03:29',0.00,'6000.0'),(118,103,45,'INV-20251011-876','2025-10-11 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-14','PAID','2025-10-11 12:11:16',0.00,'5000.0'),(119,104,45,'INV-20251011-055','2025-10-11 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-14','PAID','2025-10-11 12:12:15',0.00,'5000.0'),(120,105,48,'INV-20251011-819','2025-10-11 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-14','PAID','2025-10-11 16:47:35',0.00,'6000.0'),(121,106,48,'INV-20251013-640','2025-10-13 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-16','PAID','2025-10-13 17:40:33',0.00,'6000.0'),(122,107,45,'INV-20251013-889','2025-10-13 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-16','PAID','2025-10-13 17:42:56',0.00,'5000.0'),(123,111,48,'INV-20251014-300','2025-10-14 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-17','PAID','2025-10-14 06:58:14',0.00,'6000.0'),(124,110,48,'INV-20251014-030','2025-10-14 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-17','PAID','2025-10-14 06:59:28',0.00,'6000.0'),(125,109,45,'INV-20251014-269','2025-10-14 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-17','PAID','2025-10-14 07:00:14',0.00,'5000.0'),(126,108,48,'INV-20251014-440','2025-10-14 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-17','PAID','2025-10-14 07:00:52',0.00,'6000.0'),(127,112,48,'INV-20251014-043','2025-10-14 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-17','PAID','2025-10-14 10:06:39',0.00,'6000.0'),(129,28,48,'INV-20251014-915','2025-10-14 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-01','PAID','2025-10-14 14:49:35',0.00,'6000.0'),(131,54,54,'INV-20251014-876','2025-10-14 00:00:00',19000.00,0.00,0.00,19000.00,'CASH','2026-01-02','PAID','2025-10-14 15:08:20',0.00,'19000.0'),(132,40,51,'INV-20251014-468','2025-10-14 00:00:00',10000.00,0.00,0.00,10000.00,'CASH','2025-11-03','PAID','2025-10-14 15:23:58',0.00,'10000.0'),(133,115,48,'INV-20251015-579','2025-10-15 00:00:00',6000.00,0.00,0.00,6000.00,'ONLINE','2025-11-17','PAID','2025-10-15 06:13:06',0.00,'6000.0'),(134,116,45,'INV-20251015-707','2025-10-15 00:00:00',5000.00,0.00,0.00,5000.00,'CASH','2025-11-17','PAID','2025-10-15 06:14:03',0.00,'5000.0'),(135,117,48,'INV-20251015-270','2025-10-15 00:00:00',6000.00,0.00,0.00,6000.00,'CASH','2025-11-18','PAID','2025-10-15 19:48:36',0.00,'6000.0');
...
INSERT INTO `membership_plan` VALUES (45,'montly - ladies','Gym Only','Single Member'),(48,'monthly - gents','Gym Only','Single Member'),(51,'monthly - couple','Gym Only','Family Shared'),(54,'monthly - family','Gym Only','Family Shared'),(55,'3 monthly - gents','Gym Only','Single Member');
...
DROP TABLE IF EXISTS `membership_pricing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `membership_pricing` (
  `id` int NOT NULL AUTO_INCREMENT,
  `plan_id` int NOT NULL,
  `pricing_type` enum('One-Time','Recurring','Per Session') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cost` decimal(10,2) NOT NULL,
  `signup_fee` decimal(10,2) DEFAULT '0.00',
  `late_fee` decimal(10,2) DEFAULT '0.00',
  `grace_time` int DEFAULT '0',
  `grace_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frequency_value` int DEFAULT NULL,
  `frequency_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `max_payments` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `family_discount2` decimal(10,2) DEFAULT '0.00',
  `family_discount2_type` enum('%','LKR') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '%',
  `family_discount3` decimal(10,2) DEFAULT '0.00',
  `family_discount3_type` enum('%','LKR') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '%',
  `family_discount4` decimal(10,2) DEFAULT '0.00',
  `family_discount4_type` enum('%','LKR') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '%',
  `charge_again_on_renewal` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `plan_id` (`plan_id`),
  CONSTRAINT `membership_pricing_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE
...
LOCK TABLES `membership_pricing` WRITE;
/*!40000 ALTER TABLE `membership_pricing` DISABLE KEYS */;
INSERT INTO `membership_pricing` VALUES (30,45,'Recurring',5000.00,0.00,0.00,3,'Day(s)',1,'Month(s)','No Limit',0.00,'%',0.00,'%',0.00,'%',0),(32,48,'Recurring',6000.00,0.00,0.00,3,'Day(s)',1,'Month(s)','No Limit',0.00,'%',0.00,'%',0.00,'%',0),(34,51,'Recurring',10000.00,0.00,0.00,3,'Day(s)',1,'Month(s)','No Limit',0.00,'%',0.00,'%',0.00,'%',0),(36,54,'Recurring',19000.00,0.00,0.00,3,'Day(s)',3,'Month(s)','No Limit',0.00,'%',0.00,'%',0.00,'%',0),(37,55,'Recurring',16000.00,0.00,0.00,3,'Day(s)',3,'Month(s)','No Limit',0.00,'%',0.00,'%',0.00,'%',0);
/*!40000 ALTER TABLE `membership_pricing` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `membership_services`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `membership_services` (
  `id` int NOT NULL AUTO_INCREMENT,
  `plan_id` int NOT NULL,
  `gym_access` tinyint(1) DEFAULT '0',
  `locker_facility` tinyint(1) DEFAULT '0',
  `online_access` tinyint(1) DEFAULT '0',
  `personal_trainer_sessions` int DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `plan_id` (`plan_id`),
  CONSTRAINT `membership_services_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `membership_plan` (`id`) ON DELETE CASCADE
...
LOCK TABLES `membership_services` WRITE;
/*!40000 ALTER TABLE `membership_services` DISABLE KEYS */;
INSERT INTO `membership_services` VALUES (35,45,0,0,0,0),(38,48,0,0,0,0),(41,51,0,0,0,0),(44,54,0,0,0,0),(45,55,0,0,0,0);
/*!40000 ALTER TABLE `membership_services` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `paysheet` (
  ...
  `paydate` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Unpaid',
  PRIMARY KEY (`inid`,`employeeid`),
  KEY `empolyeeid_idx` (`employeeid`),
  CONSTRAINT `empolyeeid` FOREIGN KEY (`employeeid`) REFERENCES `customer` (`inid`) ON DELETE CASCADE ON UPDATE CASCADE
